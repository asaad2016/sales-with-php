    ...
    <div class="col-sm-6 col-md-6">
     <div class="panel panel-primary">
        ...
        <div class="panel-body">
           <input type="text" name="supplier_info" id="supplier_info" style="background-color: #4489b1;color: #fff;font-size: 32px;padding-left: 5px;" form="form1">
      
          <h3 id="supplier_name" style="margin-bottom: 10px;"></h3>
        </div>
      </div> 
    </div>
  </div>
