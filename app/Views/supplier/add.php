<?php  
$mytitle="اضافة مورد جديد";?>
<div class="header-content">
  <ol class="breadcrumb">
      <li><a href="?p=category/add">
      <i class="fa fa-plus">اضافة مورد جديد</i></a>
      </li>
      <li><a href="?p=supplier/"><i class="fa fa-dashboard"></i> لوحة تحكم الموردين</a></li>
      <li><a href="?p=supplier/index"><i class="fa fa-home"></i>الرئسية</a></li>
  </ol>
  <h1><span class="glyphicon glyphicon-home"></span>اضافة مورد جديد</h1> 
